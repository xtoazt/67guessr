...
if (!process.env.MONGODB) {
  console.log("[DEV MODE] MONGODB env variable not set - running in development mode without database".yellow);
  dbEnabled = false;
} else {
  // Connect to MongoDB
...
// Authentication is now handled by username/password system
...
function updateTotalCache() {
  fetch('http://localhost:3000/allCountries.json')
